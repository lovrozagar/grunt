...
name: implement-plan
description: >
  Implementer executes a local .tmp/plans checklist: continue, resume, or pick
  among plans. Empty /implement-plan resumes a unique in-progress or starts a
  unique ready plan; else lists and needs serial. Marks [x], skips completed
